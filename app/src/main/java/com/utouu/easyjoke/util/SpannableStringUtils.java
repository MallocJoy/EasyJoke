...
/**
 * Created by llh on 2017/2/19 20:13.
 * Function:
 * Desc:
 */
...
public class SpannableStringUtils {
    ...
    public static class Builder {
         ...
         * @return {@link Builder}
         */
        public Builder setDrawable(@NonNull Drawable drawable, int xOffset, int yOffset) {
         ...
         * @param xOffset
         * @param yOffset
         * @param resourceId 图片资源id  @return {@link Builder}
         */
        public Builder setResource(@DrawableRes int resourceId, int xOffset, int yOffset) {
