package com.utouu.easyjoke.manager;
    ...
    public static void loadCircleImg(Object obj, ImageView iv) {
        ...
        if (drawableTypeRequest != null) {
            drawableTypeRequest
                    .centerCrop()
                    .dontAnimate()
                    .transform(new BitmapTransformation[]{new GlideManager.GlideCircleTransform(iv.getContext())})
    ...
    public static void loadRoundImg(Object obj, ImageView iv, int dp) {
        ...
        if (drawableTypeRequest != null) {
            drawableTypeRequest
                    .centerCrop()
                    .dontAnimate()
                    .transform(new BitmapTransformation[]{new GlideManager.GlideRoundTransform(iv.getContext(), dp)})
